...
from neural_mmo.baselines.neural.policy import Recurrent
from neural_mmo.baselines.scripted import baselines

from deposit_env import ForageEnv
class RLlibForagePolicy(RecurrentNetwork, nn.Module):
...
class RLlibForageEnv(ForageEnv, rllib.MultiAgentEnv):
